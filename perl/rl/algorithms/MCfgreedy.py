...
class MCfGreedySampling(PosteriorSampling):
    def __init__(self,
            mdp,
    ...
    def compute_score(self, mdp_posterior, total_samples=25):
    ...
    def __repr__(self):
        return "MCfGreedySampling-f{}".format(self.f_name)